...
When the user asks about libraries, frameworks, or APIs, fetch current documentation via the Context7 MCP when it is configured, instead of relying on training data.
